  ...
  >
    ...
    >
      <div class="flex items-center gap-3 mb-4 px-2">
        <img :src="userAvatarSrc" alt="Avatar" class="w-12 h-12 rounded-full border-2 border-primary-500" />
        <div class="flex flex-col">
          <span class="font-semibold text-gray-900 dark:text-white text-sm">{{ authStore.user?.fullName }}</span>
          <span class="text-xs text-gray-500 dark:text-gray-400">{{ authStore.user?.email }}</span>
        </div>
      </div>
      <div class="px-2 mb-4">
        <div class="px-4 py-3 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center gap-3">
          <div class="flex items-center gap-3 flex-1">
            <div class="w-10 h-10 rounded-lg bg-primary-500/10 dark:bg-primary-500/20 flex items-center justify-center text-primary-500 dark:text-primary-300">
            ...
            <div class="flex flex-col">
              <span class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">{{ t('header.language') }}</span>
              <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ currentLanguageName }}</span>
            </div>
          </div>
