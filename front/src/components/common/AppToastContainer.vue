  ...
  <div class="fixed top-4 right-4 z-50 flex flex-col gap-3 pointer-events-none">
    ...
    >
      <div
        ...
        :class="{
          'border-green-500/60 text-green-700 dark:text-green-300': toast.type === 'success',
          'border-red-500/60 text-red-700 dark:text-red-300': toast.type === 'error',
          'border-primary-500/60 text-primary-700 dark:text-primary-300': toast.type === 'info',
        }"
      >
        <div class="mt-0.5">
          <svg v-if="toast.type === 'success'" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M9 12l2 2 4-4"></path>
            <circle cx="12" cy="12" r="10"></circle>
          </svg>
          <svg v-else-if="toast.type === 'error'" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="12" cy="12" r="10"></circle>
